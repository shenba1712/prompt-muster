...
3. I never stopped at MVD itself but that is a good thing to have. Especially, on days when there's a lot happening.
4. Never missed two consecutive days. Actually never missed any day.
5. Heard a bit about useEffect and useReducer and stuff, but never got to use it yet. But I'm sure that will come when it makes sense.
6. Likely priorities:
