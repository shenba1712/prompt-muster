...
| [ ] 07.4 | 2 | Delete-confirm dialog (shadcn AlertDialog) — carried from Week 1; deferred to Week 4 | 07.2 | Destructive-action UX, controlled dialog state |
