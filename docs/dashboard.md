...
| 6   | `08.1` — dotprompt spike                                                   | Complete — `docs/prompt-file-format-spike.md` + 3 real `.prompt.md` example files, two grammar ambiguities explicitly left open for `08.3` |
...
| 8   | Test suite                                                                 | Grew from 77 to 170+ tests across 22 files, all green throughout                                                 |
| 9   | Coding-challenge bonuses (Wed's `useConfirm` hook, Fri's frontmatter splitter) | Not attempted — no `coding-challenges` commits this week                                                     |
| 10  | `notes/week-04-*.md` daily notes                                          | Not done — third week running without daily notes                                                                |
| 11  | Two LinkedIn posts (Wed, Fri) + first Medium/writing-day article (Thu)    | Confirmed done (2026-08-10) — first Medium/writing-day session and both LinkedIn posts landed                     |
